...
static const gfp_t RUST_CONST_HELPER___GFP_FS __attribute__((unused)) = ___GFP_FS;
static const gfp_t RUST_CONST_HELPER___GFP_IO __attribute__((unused)) = ___GFP_IO;
